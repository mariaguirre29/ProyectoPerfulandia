...
import static jwt.security.PublicRoutes.*; //importa las rutas publicas de jwt
import static redireccion.gestion.GestionPublicRoutes.*; //importa las rutas publicas de API Gateway
import static redireccion.productos.ProductosPublicRoutes.*; //importa las rutas publicas de API Productos
import static redireccion.clientes.ClientesPublicRoutes.*; //importa las rutas publicas de API Clientes
